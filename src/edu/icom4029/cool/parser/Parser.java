...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Oct 19 18:31:45 AST 2014
  */
public class Parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\003\000\002\004\010\000\002\004\012\000\002\005\004" +
    "\000\002\005\002\000\002\006\006\000\002\006\010\000" +
    "\002\007\003\000\002\007\003\000\002\010\006" });
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\034\000\004\004\006\001\002\000\004\002\001\001" +
    "\002\000\004\002\036\001\002\000\004\051\010\001\002" +
    "\000\004\002\uffff\001\002\000\006\011\012\031\011\001" +
    "\002\000\006\032\ufffb\050\017\001\002\000\004\051\013" +
    "\001\002\000\004\031\014\001\002\000\006\032\ufffb\050" +
    "\017\001\002\000\006\032\ufffb\050\017\001\002\000\004" +
    "\032\030\001\002\000\004\033\020\001\002\000\004\051" +
    "\021\001\002\000\006\025\023\034\022\001\002\000\006" +
    "\032\ufffa\050\ufffa\001\002\000\006\052\026\054\024\001" +
    "\002\000\004\034\ufff7\001\002\000\004\034\027\001\002" +
    "\000\004\034\ufff8\001\002\000\006\032\ufff9\050\ufff9\001" +
    "\002\000\004\034\031\001\002\000\004\002\ufffd\001\002" +
    "\000\004\032\ufffc\001\002\000\004\032\034\001\002\000" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\034\000\010\002\004\003\003\004\006\001\001\000" +
    "\002\001\001\000\002\001\001\000\002\001\001\000\002" +
    "\001\001\000\002\001\001\000\006\005\032\006\014\001" +
    "\001\000\002\001\001\000\002\001\001\000\006\005\015" +
    "\006\014\001\001\000\006\005\031\006\014\001\001\000" +
    "\002\001\001\000\002\001\001\000\002\001\001\000\002" +
  ...
  public final java_cup.runtime.Symbol CUP$Parser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
        {
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 11: // assign ::= OBJECTID ASSIGN expression SEMI 
            {
              assign RESULT =null;
		...
		AbstractSymbol i = (AbstractSymbol)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new int_const(getLineNumber(), i); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 8: // feature ::= OBJECTID COLON TYPEID ASSIGN expression SEMI 
            {
              Feature RESULT =null;
		...
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = new attr(getLineNumber(), o, t, e); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 7: // feature ::= OBJECTID COLON TYPEID SEMI 
            {
              Feature RESULT =null;
		int oleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-3)).left;
		int oright = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-3)).right;
		...
		AbstractSymbol t = (AbstractSymbol)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 ...
		 RESULT = new Features(getLineNumber()); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 5: // feature_list ::= feature feature_list 
            {
              Features RESULT =null;
		 RESULT = new Features(getLineNumber()); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 4: // class ::= CLASS TYPEID INHERITS TYPEID LBRACE feature_list RBRACE SEMI 
            {
              class_ RESULT =null;
		...
		Features f = (Features)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-2)).value;
		 RESULT = new class_(getLineNumber(), n, p, f, getFilename()); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 3: // class ::= CLASS TYPEID LBRACE feature_list RBRACE SEMI 
            {
              class_ RESULT =null;
