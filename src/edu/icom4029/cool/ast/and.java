...
public class and extends Expression {
	...
	public void dump_with_types(PrintStream out, int n) {
		dump_line(out, n);
		out.println(Utilities.pad(n) + "_add");
	...
	public void semant(ClassTable classTable, class_ cl, SymbolTable symbolTable) {
		...
		if (e1.get_type() != TreeConstants.Bool || e2.get_type() != TreeConstants.Bool) {
			classTable.semantError(cl).println("non-Bool arguments: " + e1.get_type().getString() + " and " + e2.get_type().getString());
	...
	public void code(PrintStream s) {
		...
		CgenSupport.emitBeqz(CgenSupport.T2, labelFalse, s);
